                ...
                <div style="display: flex; justify-content: center; align-items: center;">
                    <table>
                        <?php if (isset($_SESSION['user'])) { ?>
                            ...
                            <?php } ?>
                            <th>
                                <a id="add-race" href="add-race.php?guid=<?= $day_num ?>" style="display: block; margin-bottom: 5px;">
                                    Add Race
                                </a>
                                <a id="delete-race" href="delete-race.php?guid=<?= $day_num ?>" onclick="confirmDeletion(event, this.href)">
                                    Delete Last Race
                                </a>
                            </th>
                        <?php } ?>
            ...
            <?php } 
                ...
                <?php if (isset($_SESSION['user'])) { ?>
                    <div class="race-day-container">
                        <h2>Day <?=$day_num?></h2>
                        <div class="date"><?=$date?></div>
                        <a id="add-race" href="add-race.php?guid=<?= $day_num ?>" style="display: block; padding: 10px 0 5px 0">
                            Add Race
                        </a>
                        <a id="delete-day" href="delete-day.php?guid=<?= $day_num ?>" onclick="confirmDeletion(event, this.href)">
                            Delete Day
                        </a>
                    </div>
                <?php } ?>
